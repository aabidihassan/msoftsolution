<section class="slider-seven" id="home">
...
<div class="swiper-container thm-swiper__slider"
    data-swiper-options='{"slidesPerView": 1, "loop": false, "effect": "fade", "pagination": { "el": "#main-slider-pagination", "type": "bullets", "clickable": true }, "navigation": { "nextEl": "#main-slider__swiper-button-next", "prevEl": "#main-slider__swiper-button-prev" }, "autoplay": { "delay": 5000 }}'>
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <div class="slider-seven__round__shape-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 877" fill="#272343">
                    <path
            ...
            <div class="slider-seven__round__shape-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 715" fill="#34a3a3">
                    <path
            ...
            <div class="slider-seven__round">
                <div class="slider-seven__round__image"
                    style="background-image: url(/images/Logo/Slider/slide-1.jpg);">
                </div>
            </div>
            <div class="auto-container">
                <div class="slider-seven__content">
                    <h5 class="slider-seven__title">Agence de web digital et de communication.</h5><!-- /.slider-seven__title -->
                    <p class="slider-seven__text">Conseil et accompagnement de vos transformations digitales.</p>
                    <a href="#about" class="slider-seven__btn thm-btn__seven">Travaillez avec nous</a>
                    <!-- /.thm-btn__seven -->
